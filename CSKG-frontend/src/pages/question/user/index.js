      ...
      data : [
        {
          title: '指令寄存器的位数取决于什么？',
          desc: '计算机组成原理',
          stars: this.state.data[0].stars + 1,
          likes: 22
        },
        {
          title: '一条指令中包含的信息有？',
              ...
              <TabPane tab="疑难问题" key="2">
                <List
                    ...
                    renderItem={(item) => (
                      ...
                      <List.Item
                        actions ={ [
                          <IconText icon={StarOutlined} text={item.stars} key="list-vertical-like-o"/>,
                          <IconText icon={StarOutlined} text={item.stars} key="list-vertical-like-o"/>,
                          <IconText icon={LikeOutlined} text={item.likes} key="list-vertical-like-o"/>,
                        ]}
                        onClick={this.clickLikes.bind(this)}
                        // actions1 ={ [
                        //   <IconText icon={CommentOutlined} text={item.likes} key="list-vertical-like-o"/>,
                        //   <IconText icon={StarOutlined} text={item.stars} key="list-vertical-like-o"/>,
                        //   <IconText icon={LikeOutlined} text={item.likes} key="list-vertical-like-o"/>,
                        // ]}
                        onClick1={this.clickStars.bind(this)}
                      >
